...
if (isset($_POST['nama_pelanggan'])) {
    ...
    if ($query) {
        ...
        echo "<script>alert('Data Gagal Diubah'); window.location='pelanggan.php'</script>";
    }
}
            ...
            <form method="post">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <textarea name="alamat" rows="5" class="form_control"><?php echo $data['alamat'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>No Telepon</td>
                        <td>:</td>
                        <td><input class="form_control" type="number" value="<?php echo $data['no_telepon'] ?>" name="no_telepon"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
