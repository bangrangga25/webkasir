            ...
            <form method="post">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>:</td>
                        <td><input class="form_control" type="text" name="nama_produk"></td>
                    </tr>
                    <tr>
                        <td width="200">Harga</td>
                        <td>:</td>
                        <td><input class="form_control" name="harga"></td>
                    </tr>
                    
                    <tr>
                        <td>Jumlah Stok</td></td>
                        <td>:</td>
                        <td><input class="form_control" type="number" step="0" name="stok"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
